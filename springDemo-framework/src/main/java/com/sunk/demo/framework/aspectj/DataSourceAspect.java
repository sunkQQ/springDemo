...
import com.sunk.demo.common.annotation.DataSource;
...
public class DataSourceAspect {
    ...
    @Pointcut("@annotation(com.sunk.demo.common.annotation.DataSource)"
            + "|| @within(com.sunk.demo.common.annotation.DataSource)")
