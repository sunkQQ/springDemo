...
import com.sunk.demo.framework.shiro.service.SysShiroService;
...
public class OnlineSessionDAO extends EnterpriseCacheSessionDAO {
	...
	public void syncToDb(OnlineSession onlineSession) {
		...
		if (lastSyncTimestamp != null) {
			...
			// isGuest = true 访客
			boolean isGuset = onlineSession.getUserId() == null || onlineSession.getUserId() == 0L;
			// session 数据变更了 同步
			if (!isGuset == false && onlineSession.isAttributeChanged()) {
				needSync = true;
			}
